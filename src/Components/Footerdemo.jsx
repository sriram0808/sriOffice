...
import { FaFacebook, FaInstagram, FaTwitter, FaWhatsapp } from 'react-icons/fa';
      ...
      <div className="row">
        <div className='col-12 col-lg-4    footerBlock'>
        ...
        <div className="col-12 col-lg-8 footerRight py-4 py-md-5 py-xxl-8 ">
          <div className="row justify-content-center">
            <div className="col-12 col-md-11 col-xxl-10">
                ...
                <div className="col-sm-3">
                  <div>
                    ...
                    <ul className="list-unstyled service">
                      <li className="mb-3">
                      <a href="/mobileapp"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> Mobile Development </a>
                      </li>
                      <li className="mb-3">
                      <a href="/webdevelopment"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> Web Development </a>
                      </li>
                      <li className="mb-3">
                      <a href="/uiux"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> UI/UX Development </a>
                      </li>
                      <li className="mb-3">
                      <a href="/aidevelopment"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> AI Development </a>

                      </li>
                      <li className="mb-3">
                      <a href="/cripto"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> Crypto Trading </a>
                      </li>
                      <li className="mb-3">
                        <a href="/neft"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> NFT Marketing </a>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <a href="/"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> Home</a>
            </li>
           
            <li className="mb-3">
          
              
              <a href="/about"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> About</a>
            </li>
            <li className="mb-3">
          
               <a href="/service"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> Service</a>
            </li>
            <li className="mb-3">
          
               <a href="/career"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> Career</a>
            </li>
            <li className="mb-3">
        
               <a href="/contact"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> Contact</a>
            </li>
            <li className="mb-3">

            <a href="/contact"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> Terms & Condition</a>
            </li>
            <li className="mb-3">

            <a href="/contact"  className="link-secondary text-decoration-none footerSubTitle"><GoArrowRight /> Privacy Policy</a>
            </li>
