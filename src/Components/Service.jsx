        ...
        <div>
                ...
                <h1 className="mb-4 display-5 text-center  serviceTitle"  >Our Services</h1>
                        ...
                        <div className="row" data-aos="fade-right">
                            ...
                            <img src="https://res.cloudinary.com/deowghzbg/image/upload/v1719644960/mobile_we3e5y.png" alt="" className='img-fluid mx-3 mt-3' style={{height:"45px",width:"45px"}}/>
                                ...
                                <a href='/mobileapp' style={{ position: 'absolute', bottom: '10px', right: '10px' }}>
                                        <img src="https://res.cloudinary.com/deowghzbg/image/upload/v1719644956/learnnn_rld4rb.png" alt="" className="img-fluid mx-3 mb-3" style={{ height: "25px" }} />
                                 </a>
                                </div>
                            </div>
                            </div>
                            ...
                            <div className="col-md-4 mb-4">
                            <div className="card serviceCard">
                            <img src="https://res.cloudinary.com/deowghzbg/image/upload/v1719644914/web_p6wxa8.png" alt="" className='img-fluid mx-3 mt-3'  style={{height:"45px",width:"45px"}}/>
                                <div className="card-body">
                            ...
                            <div className="col-md-4 mb-4">
                            <div className="card serviceCard">
                            <img src="https://res.cloudinary.com/deowghzbg/image/upload/v1719644910/uiux_rmktbp.png" alt="" className='img-fluid mx-3 mt-3' style={{height:"45px",width:"45px"}}/>
                            <div className="card-body">
                        ...
                        <div className="row mt-0" data-aos="fade-right">
                            <div className="col-md-4 mb-4">
                            <div className="card serviceCard">
                            <img src="https://res.cloudinary.com/deowghzbg/image/upload/v1719652113/ai_vqe0nl.png" alt="" className='img-fluid mx-3 mt-3' style={{height:"45px",width:"45px"}}/>
                                <div className="card-body">
                            ...
                            <div className="col-md-4 mb-4">
                            <div className="card serviceCard">
                            <img src="https://res.cloudinary.com/deowghzbg/image/upload/v1719644933/crypto_s5vm1t.png" alt="" className='img-fluid mx-3 mt-3' style={{height:"45px",width:"45px"}}/>
                                <div className="card-body">
                            ...
                            <div className="col-md-4 mb-4">
                            <div className="card serviceCard">
                            <img src="https://res.cloudinary.com/deowghzbg/image/upload/v1719644895/nft_p8lakq.png" alt="" className='img-fluid mx-3 mt-3' style={{height:"45px",width:"45px"}}/>
                                <div className="card-body">
                                <h1 className="mb-3 serviceCardTitle" >NFT Marketing</h1>
                                <p className="mb-3 serviceCardSubTitle">Thamizhan Solution is your premier NFT service provider, specializing in tailored solutions for NFT creation, management, and monetization. Our expertise ensures seamless blockchain integration, empowering artists, creators, and businesses to leverage NFTs' unique benefits.</p>
